...
A Tetra addon, created by [AceTheEldritchKing](https://github.com/AceTheEldritchKing) and MindFaer.
Adds many new and unique modules, from rapiers to maces and even pop culture weapons.
...
cd "../Art-of-Forging-Refreshed" && ./gradlew.bat build
```
